...
open class HybridSoundSpec_cxx {
  ...
  @inline(__always)
  public final func startAmbientLoop(uri: std.string, volume: Double) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.startAmbientLoop(uri: String(uri), volume: volume)
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
