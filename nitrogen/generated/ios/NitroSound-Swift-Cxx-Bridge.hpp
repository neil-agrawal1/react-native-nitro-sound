...
namespace margelo::nitro::sound::bridge::swift {
  ...
  // pragma MARK: std::function<void(const std::string& /* filename */, const std::string& /* filePath */)>
  /**
   * Specialized version of `std::function<void(const std::string&, const std::string&)>`.
   */
  using Func_void_std__string_std__string = std::function<void(const std::string& /* filename */, const std::string& /* filePath */)>;
  /**
   * Wrapper class for a `std::function<void(const std::string& / * filename * /, const std::string& / * filePath * /)>`, this can be used from Swift.
   */
  class Func_void_std__string_std__string_Wrapper final {
  public:
    explicit Func_void_std__string_std__string_Wrapper(std::function<void(const std::string& /* filename */, const std::string& /* filePath */)>&& func): _function(std::make_unique<std::function<void(const std::string& /* filename */, const std::string& /* filePath */)>>(std::move(func))) {}
    inline void call(std::string filename, std::string filePath) const noexcept {
      _function->operator()(filename, filePath);
    }
  private:
    std::unique_ptr<std::function<void(const std::string& /* filename */, const std::string& /* filePath */)>> _function;
  } SWIFT_NONCOPYABLE;
  ...
  void* NON_NULL get_std__shared_ptr_HybridSoundSpec_(std__shared_ptr_HybridSoundSpec_ cppType) noexcept;
