...
namespace margelo::nitro::sound {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/sound/Variant_NullType_String;";
  ...
  namespace JVariant_NullType_String_impl {
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/sound/Variant_NullType_String$First;";
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/sound/Variant_NullType_String$Second;";
